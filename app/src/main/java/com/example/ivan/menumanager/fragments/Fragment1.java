...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       productLayout = (LinearLayout) root.findViewById(R.id.product_view_layout);
       fridgeLayout = (LinearLayout) root.findViewById(R.id.recycle_listview_layout);
        ...
        fridgeImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Fridge is pressed", Toast.LENGTH_SHORT).show();
                nextFragment();
            }
        });
        return root;
